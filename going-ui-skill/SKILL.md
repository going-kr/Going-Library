...
| 작업 | 1순위 | 2순위 | 3순위 (필요 시) |
|------|-------|-------|----------------|
| .gud 파일 생성 | `ui-json.md` | `ui-json-controls.md` | `ui-json-controls-ext.md` (GoDataGrid/그래프 등) / `ui-json-input-value.md` (GoInput/GoValue) / `ui-json-containers.md` / `ui-json-imagecanvas.md` |
