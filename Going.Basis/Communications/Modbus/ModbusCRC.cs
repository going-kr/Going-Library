...
namespace Going.Basis.Communications.Modbus
{
    ...
    {
        #region CRC Table
        static byte[] auchCRCHi =  {    0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x01, 0xC0, 0x80, 0x41, 0x00, 0xC1, 0x81,
        ...
        static byte[] auchCRCLo = {     0x00, 0xC0, 0xC1, 0x01, 0xC3, 0x03, 0x02, 0xC2, 0xC6, 0x06, 0x07, 0xC7, 0x05, 0xC5, 0xC4,
        ...
        #endregion
        #region IntToHex
        static string IntToHex(byte pby, int n)
        {
