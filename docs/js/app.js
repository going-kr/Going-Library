    ...
    items: [
      { label: 'Overview', href: '../basis/index.html', type: 'page' },
      {
        ...
        children: [
          ...
          { label: 'WriteEventArgs (LS)', href: '../basis/communications-ls.html#class-WriteEventArgs-LS', type: 'class' },
          { label: 'TimeoutEventArgs (LS)', href: '../basis/communications-ls.html#class-TimeoutEventArgs-LS', type: 'class' },
          ...
          { label: 'WriteEventArgs (MC)', href: '../basis/communications-mitsubishi.html#class-WriteEventArgs-MC', type: 'class' },
          { label: 'TimeoutEventArgs (MC)', href: '../basis/communications-mitsubishi.html#class-TimeoutEventArgs-MC', type: 'class' },
          { label: 'Mems', href: '../basis/communications-modbus.html#class-Mems', type: 'class' },
          { label: 'ModbusWork', href: '../basis/communications-modbus.html#class-ModbusWork', type: 'class' },
          { label: 'ModbusBitReadEventArgs', href: '../basis/communications-modbus.html#class-ModbusBitReadEventArgs', type: 'class' },
          { label: 'ModbusWordReadEventArgs', href: '../basis/communications-modbus.html#class-ModbusWordReadEventArgs', type: 'class' },
          { label: 'ModbusBitWriteEventArgs', href: '../basis/communications-modbus.html#class-ModbusBitWriteEventArgs', type: 'class' },
          { label: 'ModbusWordWriteEventArgs', href: '../basis/communications-modbus.html#class-ModbusWordWriteEventArgs', type: 'class' },
          { label: 'ModbusMultiBitWriteEventArgs', href: '../basis/communications-modbus.html#class-ModbusMultiBitWriteEventArgs', type: 'class' },
          { label: 'ModbusMultiWordWriteEventArgs', href: '../basis/communications-modbus.html#class-ModbusMultiWordWriteEventArgs', type: 'class' },
          { label: 'ModbusWordBitSetEventArgs', href: '../basis/communications-modbus.html#class-ModbusWordBitSetEventArgs', type: 'class' },
          { label: 'ModbusTimeoutEventArgs', href: '../basis/communications-modbus.html#class-ModbusTimeoutEventArgs', type: 'class' },
          { label: 'ModbusCRCErrorEventArgs', href: '../basis/communications-modbus.html#class-ModbusCRCErrorEventArgs', type: 'class' },
          { label: 'ModbusBitReadRequestArgs', href: '../basis/communications-modbus.html#class-ModbusBitReadRequestArgs', type: 'class' },
          { label: 'ModbusWordReadRequestArgs', href: '../basis/communications-modbus.html#class-ModbusWordReadRequestArgs', type: 'class' },
          { label: 'ModbusBitWriteRequestArgs', href: '../basis/communications-modbus.html#class-ModbusBitWriteRequestArgs', type: 'class' },
          { label: 'ModbusWordWriteRequestArgs', href: '../basis/communications-modbus.html#class-ModbusWordWriteRequestArgs', type: 'class' },
          { label: 'ModbusMultiBitWriteRequestArgs (RTU)', href: '../basis/communications-modbus.html#class-ModbusMultiBitWriteRequestArgs-RTU', type: 'class' },
          { label: 'ModbusMultiBitWriteRequestArgs (TCP)', href: '../basis/communications-modbus.html#class-ModbusMultiBitWriteRequestArgs-TCP', type: 'class' },
          { label: 'ModbusMultiWordWriteRequestArgs (RTU)', href: '../basis/communications-modbus.html#class-ModbusMultiWordWriteRequestArgs-RTU', type: 'class' },
          { label: 'ModbusMultiWordWriteRequestArgs (TCP)', href: '../basis/communications-modbus.html#class-ModbusMultiWordWriteRequestArgs-TCP', type: 'class' },
          { label: 'ModbusWordBitSetRequestArgs', href: '../basis/communications-modbus.html#class-ModbusWordBitSetRequestArgs', type: 'class' },
