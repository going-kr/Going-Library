...
namespace Going.UI.ImageCanvas
{
    ...
    public class IcProgress : GoControl
    {
        ...
        /// </summary>
        [GoImageProperty(PCategory.Control, 6)] public string? OffBarImage { get; set; }

        /// <summary>
        /// 값 표시 서식 문자열을 가져오거나 설정합니다.
        /// </summary>
        [GoProperty(PCategory.Control, 7)] public string FormatString { get; set; } = "0";
        /// <summary>
        /// 최솟값을 가져오거나 설정합니다.
        /// </summary>
        [GoProperty(PCategory.Control, 8)] public double Minimum { get; set; } = 0D;
        /// <summary>
        /// 최댓값을 가져오거나 설정합니다.
        /// </summary>
        [GoProperty(PCategory.Control, 9)] public double Maximum { get; set; } = 100D;
        /// <summary>
