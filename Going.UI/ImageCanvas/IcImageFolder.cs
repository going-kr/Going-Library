...
{
    public class IcImageFolder : IDisposable
    {
        #region Const
        ...
        [JsonConstructor]
        public IcImageFolder(string? imageFolder, Dictionary<string, IcOnOffImage> pages, Dictionary<string, IcOnOffImage> containers, Dictionary<string, IcOnOffImage> miscs, Dictionary<string, Dictionary<int, SKBitmap?>> states, Dictionary<string, List<SKBitmap?>> animations)
        {
            ImageFolder = imageFolder;
    ...
    public class IcOnOffImage
    {
        [JsonInclude]
        public SKBitmap? On { get; set; }

        [JsonInclude]
        public SKBitmap? Off { get; set; }

        [JsonConstructor]
        public IcOnOffImage(SKBitmap? on, SKBitmap? off) { On = on; Off = off; }
        public IcOnOffImage() { }
