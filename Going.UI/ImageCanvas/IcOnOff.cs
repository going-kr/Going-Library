...
namespace Going.UI.ImageCanvas
{
    ...
    public class IcOnOff : GoControl
    {
        ...
        /// </summary>
        [GoProperty(PCategory.Control, 9)] public GoDirectionHV IconDirection { get; set; } = GoDirectionHV.Horizon;
        /// <summary>
        ...
        /// </summary>
        [GoMultiLineProperty(PCategory.Control, 1)] public string Text { get; set; } = "onoff";
        /// <summary>
        /// 글꼴 이름을 가져오거나 설정합니다.
        /// </summary>
        ...
        protected override void OnDraw(SKCanvas canvas, GoTheme thm)
        {
            ...
            if (Design != null && Parent != null)
            {
                ...
                if (offs?.Count > 0 && ons?.Count > 0)
                {
                    ...
                    canvas.DrawImage(OnOff ? on : off, Util.FromRect(Convert.ToInt32(Left * sx), Convert.ToInt32(Top * sy), Convert.ToInt32(Width * sx), Convert.ToInt32(Height * sy)), rtBox, Util.Sampling);
