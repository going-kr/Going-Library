...
namespace Going.UI.Controls
{
    ...
    public class GoAnimate : GoControl
    {
        ...
        /// </summary>
        [GoImageProperty(PCategory.Control, 1)] public string? OnImage { get; set; }
        /// <summary>
        /// OFF 상태에서 표시할 이미지의 리소스 이름을 가져오거나 설정합니다.
        /// </summary>
        [GoImageProperty(PCategory.Control, 2)] public string? OffImage { get; set; }
        /// <summary>
        /// 이미지 스케일 모드를 가져오거나 설정합니다.
        /// </summary>
        [GoProperty(PCategory.Control, 3)] public GoImageScaleMode ScaleMode { get; set; } = GoImageScaleMode.Real;
        /// <summary>
        /// 모서리 둥글기 타입을 가져오거나 설정합니다.
        /// </summary>
        [GoProperty(PCategory.Control, 4)] public GoRoundType Round { get; set; } = GoRoundType.Rect;
        /// <summary>
        /// 프레임 전환 간격(밀리초)을 가져오거나 설정합니다.
        /// </summary>
        [GoProperty(PCategory.Control, 5)] public int Time { get; set; } = 30;
        /// <summary>
