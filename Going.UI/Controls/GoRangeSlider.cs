...
namespace Going.UI.Controls
{
    ...
    public class GoRangeSlider : GoControl, IDisposable
    {
        ...
        [GoProperty(PCategory.Control, 8)] public float IconSize { get; set; } = 12;
        /// <summary>아이콘과 텍스트 사이 간격</summary>
        [GoProperty(PCategory.Control, 9)] public float IconGap { get; set; } = 5;
        /// <summary>아이콘 배치 방향</summary>
        [GoProperty(PCategory.Control, 19)] public GoDirectionHV IconDirection { get; set; }
        #endregion

        #region 슬라이더 라벨 설정
        /// <summary>슬라이더 라벨 텍스트</summary>
        [GoMultiLineProperty(PCategory.Control, 1)] public string Text { get; set; } = "slider";
        ...
        [GoProperty(PCategory.Control, 15)] public bool BackgroundDraw { get; set; }
        /// <summary>테두리만 그리기 여부</summary>
        [GoProperty(PCategory.Control, 16)] public bool BorderOnly { get; set; }
        #endregion
        ...
        [GoProperty(PCategory.Control, 11)] public string BoxColor { get; set; } = "Back";
        /// <summary>슬라이더 핸들 및 진행 바 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 12)] public string SliderColor { get; set; } = "Base5";
        /// <summary>트랙 배경 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 13)] public string ProgressColor { get; set; } = "Base1";
        /// <summary>테두리 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 14)] public string BorderColor { get; set; } = "danger";
        /// <summary>테두리 두께</summary>
        [GoProperty(PCategory.Control, 18)] public float BorderWidth { get; set; } = 1.5F;
        /// <summary>모서리 둥글기 유형</summary>
        [GoProperty(PCategory.Control, 17)] public GoRoundType Round { get; set; } = GoRoundType.All;
        /// <summary>슬라이더 방향 (가로/세로)</summary>
        [GoProperty(PCategory.Control, 20)] public GoDirectionHV Direction { get; set; } = GoDirectionHV.Horizon;
        #endregion

        #region 슬라이더 표시 설정(외형)
        /// <summary>핸들에 값 라벨 표시 여부</summary>
        [GoProperty(PCategory.Control, 23)] public bool ShowValueLabel { get; set; } = true;
        /// <summary>값 표시 형식 문자열</summary>
        [GoProperty(PCategory.Control, 24)] public string ValueFormat { get; set; } = "0";
        /// <summary>트랙 바 두께 (픽셀)</summary>
        [GoProperty(PCategory.Control, 21)] public int BarSize { get; set; } = 4;
        /// <summary>핸들 반지름 (픽셀)</summary>
        [GoProperty(PCategory.Control, 22)] public float HandleRadius { get; set; } = 15f;
        /// <summary>그림자 효과 사용 여부</summary>
        [GoProperty(PCategory.Control, 25)] public bool EnableShadow { get; set; } = true;
        /// <summary>호버 시 핸들 확대 비율</summary>
        [GoProperty(PCategory.Control, 26)] public float HandleHoverScale { get; set; } = 1.05f;
        #endregion

        #region 틱(단계) 설정
        /// <summary>증감 단위. null이면 연속 값을 사용합니다.</summary>
        [GoProperty(PCategory.Control, 27)] public double? Tick { get; set; } = null;
        /// <summary>틱 표시 여부</summary>
        [GoProperty(PCategory.Control, 28)] public bool ShowTicks { get; set; } = false;
        /// <summary>틱 개수</summary>
        [GoProperty(PCategory.Control, 29)] public int TickCount { get; set; } = 5;
        /// <summary>틱 표시 크기 (픽셀)</summary>
        [GoProperty(PCategory.Control, 30)] public float TickSize { get; set; } = 10f;
        #endregion
        ...
        /// <summary>최댓값</summary>
        [GoProperty(PCategory.Control, 32)]
        ...
        [GoProperty(PCategory.Control, 33)] public float MinHandleSeparation { get; set; } = 0.05f;
        ...
        #region Constructor
        /// <summary>
        /// <see cref="GoRangeSlider"/> 클래스의 새 인스턴스를 초기화합니다.
        /// </summary>
