...
namespace Going.UI.Controls
{
    ...
    public class GoRadioButton : GoControl
    {
        ...
        [GoProperty(PCategory.Control, 18)] public GoDirectionHV IconDirection { get; set; }
        ...
        [GoProperty(PCategory.Control, 11)] public string ButtonColor { get; set; } = "Base3";
        /// <summary>선택 상태의 버튼 배경 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 12)] public string CheckedButtonColor { get; set; } = "Select";
        /// <summary>선택 해제 상태의 테두리 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 13)] public string BorderColor { get; set; } = "Base3";
        /// <summary>선택 상태의 테두리 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 14)] public string CheckedBorderColor { get; set; } = "Select";
        /// <summary>모서리 둥글기 유형</summary>
        [GoProperty(PCategory.Control, 16)] public GoRoundType Round { get; set; } = GoRoundType.All;
        ...
        [GoProperty(PCategory.Control, 15)] public string? ButtonColor2 { get; set; } = null;
        ...
        [GoProperty(PCategory.Control, 6)] public GoAutoFontSize AutoFontSize { get; set; } = GoAutoFontSize.NotUsed;
        /// <summary>자동 아이콘 크기 설정</summary>
        [GoProperty(PCategory.Control, 7)] public GoAutoFontSize AutoIconSize { get; set; } = GoAutoFontSize.NotUsed;
        #endregion
