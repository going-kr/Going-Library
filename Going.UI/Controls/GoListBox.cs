...
namespace Going.UI.Controls
{
    ...
    public class GoListBox : GoControl
    {
        ...
        /// </summary>
        [GoProperty(PCategory.Control, 13)] public GoContentAlignment ItemAlignment { get; set; } = GoContentAlignment.MiddleCenter;
        /// <summary>
        ...
        /// </summary>
        [GoChildWrappers]
        [GoProperty(PCategory.Control, 15)] public ObservableList<GoListItem> Items { get; set; } = [];
        /// <summary>
        /// 현재 선택된 항목 목록을 가져옵니다.
        /// </summary>
