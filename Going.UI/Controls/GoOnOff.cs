...
namespace Going.UI.Controls
{
    ...
    public class GoOnOff : GoControl
    {
        ...
        [GoProperty(PCategory.Control, 18)] public bool DrawText { get; set; } = true;
        ...
        [GoProperty(PCategory.Control, 11)] public string BoxColor { get; set; } = "Base1";
        ...
        [GoProperty(PCategory.Control, 13)] public string CursorColor { get; set; } = "Base3";
        /// <summary>On 상태 색상 (테마 색상 키 또는 색상명)</summary>
        [GoProperty(PCategory.Control, 14)] public string OnColor { get; set; } = "lime";
        /// <summary>Off 상태 색상 (테마 색상 키 또는 색상명)</summary>
        [GoProperty(PCategory.Control, 15)] public string OffColor { get; set; } = "gray";
        /// <summary>커서에 아이콘 표시 여부</summary>
        [GoProperty(PCategory.Control, 19)] public bool CursorIconDraw { get; set; } = true;
        ...
        [GoProperty(PCategory.Control, 8)] public float? CursorIconSize { get; set; }
        /// <summary>모서리 둥글기. null이면 컨트롤 높이를 사용합니다.</summary>
        [GoProperty(PCategory.Control, 17)] public float? Corner { get; set; }
        ...
        [GoProperty(PCategory.Control, 9)] public GoAutoFontSize AutoCursorIconSize { get; set; } = GoAutoFontSize.NotUsed;
        #endregion
