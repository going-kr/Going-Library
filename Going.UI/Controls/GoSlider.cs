...
namespace Going.UI.Controls
{
    ...
    public class GoSlider : GoControl, IDisposable
    {
        ...
        [GoProperty(PCategory.Control, 6)] public float IconSize { get; set; } = 12;
        /// <summary>아이콘과 텍스트 사이 간격</summary>
        [GoProperty(PCategory.Control, 7)] public float IconGap { get; set; } = 5;
        /// <summary>아이콘 배치 방향</summary>
        [GoProperty(PCategory.Control, 17)] public GoDirectionHV IconDirection { get; set; }
        #endregion
        ...
        [GoProperty(PCategory.Control, 13)] public bool BackgroundDraw { get; set; }
        /// <summary>테두리만 그리기 여부</summary>
        [GoProperty(PCategory.Control, 14)] public bool BorderOnly { get; set; }
        #endregion
        ...
        [GoProperty(PCategory.Control, 9)] public string BoxColor { get; set; } = "Back";
        /// <summary>슬라이더 핸들 및 진행 바 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 10)] public string SliderColor { get; set; } = "Base5";
        /// <summary>트랙 배경 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 11)] public string ProgressColor { get; set; } = "Base1";
        /// <summary>테두리 색상 (테마 색상 키)</summary>
        [GoProperty(PCategory.Control, 12)] public string BorderColor { get; set; } = "danger";
        /// <summary>테두리 두께</summary>
        [GoProperty(PCategory.Control, 16)] public float BorderWidth { get; set; } = 1.5F;
        /// <summary>모서리 둥글기 유형</summary>
        [GoProperty(PCategory.Control, 15)] public GoRoundType Round { get; set; } = GoRoundType.All;
        ...
        [GoProperty(PCategory.Control, 22)] public bool ShowValueLabel { get; set; } = true;
        /// <summary>값 표시 형식 문자열</summary>
        [GoProperty(PCategory.Control, 23)] public string ValueFormat { get; set; } = "0";
        /// <summary>트랙 바 두께 (픽셀)</summary>
        [GoProperty(PCategory.Control, 19)] public int BarSize { get; set; } = 4;
        /// <summary>핸들 반지름 (픽셀)</summary>
        [GoProperty(PCategory.Control, 20)] public float HandleRadius { get; set; } = 15f;
        /// <summary>그림자 효과 사용 여부</summary>
        [GoProperty(PCategory.Control, 24)] public bool EnableShadow { get; set; } = true;
        ...
        [GoProperty(PCategory.Control, 25)] public double? Tick { get; set; } = null;
        /// <summary>틱 표시 여부</summary>
        [GoProperty(PCategory.Control, 26)] public bool ShowTicks { get; set; } = false;
        /// <summary>틱 개수</summary>
        [GoProperty(PCategory.Control, 27)] public int TickCount { get; set; } = 5;
        /// <summary>틱 표시 크기 (픽셀)</summary>
        [GoProperty(PCategory.Control, 28)] public float TickSize { get; set; } = 10f;
        #endregion
