...
{
    /// <summary>
    /// 타이틀바 컨트롤. 디자인 상단에 표시되며 제목, 사이드바 확장/축소 버튼을 포함합니다.
    /// </summary>
    ...
    /// <summary>
    /// 사이드바 컨트롤. 디자인 좌측 또는 우측에 표시되며 확장/축소 애니메이션을 지원합니다.
    /// </summary>
