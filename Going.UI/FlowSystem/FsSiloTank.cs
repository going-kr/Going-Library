...
namespace Going.UI.FlowSystem
{
    ...
    public class FsSiloTank : FsFlowObject
    {
        ...
        /// 수위 최소값을 가져오거나 설정합니다.
        /// </summary>
        [GoProperty(PCategory.Control, 9)] public double Minimum { get; set; } = 0;

        /// <summary>
        /// 수위 최대값을 가져오거나 설정합니다.
        /// </summary>
        [GoProperty(PCategory.Control, 10)] public double Maximum { get; set; } = 100;
        ...
        /// </summary>
        [GoProperty(PCategory.Control, 12)] public bool UseInlet { get; set; } = true;
