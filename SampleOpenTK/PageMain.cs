...
namespace SampleOpenTK
{
    public class PageMain : GoPage
    {
        ...
        public PageMain()
        {
            ...
            // pnl_tbl.Childrens.Add(new GoRangeSlider { HandleRadius = 25f, Fill = true, Margin = new GoPadding(3), Text = "슬라이더", Direction = GoDirectionHV.Horizon, ValueFormat = "0.0", BackgroundDraw = false }, 1, 9, 2);
            pnl_tbl.Childrens.Add(new GoTrendGraph { Fill = true, Margin = new GoPadding(3), Text = "슬라이더", BackgroundDraw = false }, 1, 9, 2);
