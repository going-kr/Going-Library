...
namespace SampleOpenTK.Pages
{
    public class PageGraph : GoPage
    {
        ...
        public PageGraph()
        {
            ...
            grpBar = new GoBarGraph { Fill = true, Margin = new GoPadding(0), XAxisName = "Month", Minimum = 0, Maximum = 10000, Direction = GoDirectionHV.Vertical, Mode = GoBarGraphMode.Stack, BarSize = 20, BarGap = 20 };
