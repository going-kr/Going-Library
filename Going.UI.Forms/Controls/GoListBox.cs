...
namespace Going.UI.Forms.Controls
{
    public class GoListBox : GoWrapperControl<Going.UI.Controls.GoListBox>
    {
        ...
        [Browsable(false)]
        public ObservableList<GoListItem> Items { get => Control.Items; set { if (Control.Items != value) { Control.Items = value; Invalidate(); } } }
        ...
        public event EventHandler<ListItemEventArgs>? ItemClicked { add => Control.ItemClicked += value; remove => Control.ItemClicked -= value; }
        public event EventHandler<ListItemEventArgs>? ItemLongClicked { add => Control.ItemLongClicked += value; remove => Control.ItemLongClicked -= value; }
        public event EventHandler<ListItemEventArgs>? ItemDoubleClicked { add => Control.ItemDoubleClicked += value; remove => Control.ItemDoubleClicked -= value; }
        #endregion
