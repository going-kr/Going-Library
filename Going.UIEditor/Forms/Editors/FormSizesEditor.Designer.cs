namespace Going.UIEditor.Forms.Editors
{
    partial class FormSizesEditor
    {
        ...
        private void InitializeComponent()
        {
            ...
            goTableLayoutPanel1.Location = new Point(5, 396);
            ...
            goTableLayoutPanel1.Size = new Size(454, 40);
            ...
            btnOK.FillStyle = Going.UI.Datas.GoButtonFillStyle.Flat;
            btnOK.FontName = "나눔고딕";
            btnOK.FontSize = 12F;
            ...
            btnOK.Location = new Point(299, 5);
            ...
            btnCancel.FillStyle = Going.UI.Datas.GoButtonFillStyle.Flat;
            ...
            btnCancel.Location = new Point(379, 5);
            ...
            goTableLayoutPanel2.Size = new Size(454, 391);
            ...
            goContainer1.Size = new Size(444, 20);
            ...
            btnAdd.ContentAlignment = Going.UI.Enums.GoContentAlignment.MiddleCenter;
            btnAdd.Dock = DockStyle.Right;
            btnAdd.FillStyle = Going.UI.Datas.GoButtonFillStyle.Flat;
            btnAdd.FontName = "나눔고딕";
            btnAdd.FontSize = 12F;
            btnAdd.FontStyle = Going.UI.Enums.GoFontStyle.Normal;
            btnAdd.IconDirection = Going.UI.Enums.GoDirectionHV.Horizon;
            btnAdd.IconGap = 5F;
            btnAdd.IconSize = 14F;
            btnAdd.IconString = "fa-plus";
            btnAdd.Location = new Point(354, 0);
            btnAdd.Name = "btnAdd";
            btnAdd.Round = Going.UI.Enums.GoRoundType.All;
            ...
            btnDel.ContentAlignment = Going.UI.Enums.GoContentAlignment.MiddleCenter;
            btnDel.Dock = DockStyle.Right;
            btnDel.FillStyle = Going.UI.Datas.GoButtonFillStyle.Flat;
            btnDel.FontName = "나눔고딕";
            btnDel.FontSize = 12F;
            btnDel.FontStyle = Going.UI.Enums.GoFontStyle.Normal;
            btnDel.IconDirection = Going.UI.Enums.GoDirectionHV.Horizon;
            btnDel.IconGap = 5F;
            btnDel.IconSize = 14F;
            btnDel.IconString = "fa-minus";
            btnDel.Location = new Point(414, 0);
            btnDel.Name = "btnDel";
            btnDel.Round = Going.UI.Enums.GoRoundType.All;
            ...
            goLabel1.ContentAlignment = Going.UI.Enums.GoContentAlignment.MiddleLeft;
            ...
            btnInsert.ContentAlignment = Going.UI.Enums.GoContentAlignment.MiddleCenter;
            btnInsert.Dock = DockStyle.Right;
            btnInsert.FillStyle = Going.UI.Datas.GoButtonFillStyle.Flat;
            btnInsert.FontName = "나눔고딕";
            btnInsert.FontSize = 12F;
            btnInsert.FontStyle = Going.UI.Enums.GoFontStyle.Normal;
            btnInsert.IconDirection = Going.UI.Enums.GoDirectionHV.Horizon;
            btnInsert.IconGap = 5F;
            btnInsert.IconSize = 14F;
            btnInsert.IconString = "fa-arrow-right-to-bracket";
            btnInsert.Location = new Point(384, 0);
            btnInsert.Name = "btnInsert";
            btnInsert.Round = Going.UI.Enums.GoRoundType.All;
        ...
        private Going.UI.Forms.Containers.GoTableLayoutPanel goTableLayoutPanel2;
        ...
        private Going.UI.Forms.Controls.GoButton btnAdd;
        private Going.UI.Forms.Controls.GoButton btnDel;
        private Going.UI.Forms.Controls.GoButton btnInsert;
    }
}